...
namespace xx {
    ...
    // 固定 2 像素 边缘线宽. value 0 ~ 1 foreground 比例
    struct Shader_HPBar2Data {
    ...
    struct Shader_HPBar2 : xx::Shader {
        ...
        std::unique_ptr<Shader_HPBar2Data[]> data = std::make_unique_for_overwrite<Shader_HPBar2Data[]>(maxNums);
        int32_t count{};
